/**
 * `bee-router xai video` — generate a Grok Imagine video through the local
 * bee-router gateway and save the result as an MP4 file.
 *
...
const HELP = `
Usage: bee-router xai video --prompt "..." [options]

Generate a Grok Imagine video via your local bee-router gateway
...
Options:
  ...
  --api-key <key>         bee-router API key (or env NINE_ROUTER_API_KEY)
...
async function run(argv) {
  ...
  try {
    ...
    const connectionId = create.headers["x-bee-router-connection-id"] || null;
