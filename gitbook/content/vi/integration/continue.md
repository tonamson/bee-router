...
Tích hợp BeeRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.
...
### 2. Thêm Cấu hình Model BeeRouter
...
3. Chọn model BeeRouter ưa thích
...
- Kiểm tra BeeRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến BeeRouter
