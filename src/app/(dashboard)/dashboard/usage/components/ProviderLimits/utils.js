...
/**
 * Trim hidden quota keys that no longer exist on the current quota list.
 * Prevents phantom hidden rows from surviving after upstream model deprecation/renames.
 */
