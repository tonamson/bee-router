...
Integra BeeRouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.
...
### 2. Agregar configuración de modelo de BeeRouter
...
3. Elige tu modelo preferido de BeeRouter
...
- Selecciona el modelo correcto de BeeRouter
...
- Verifica la latencia de red hacia BeeRouter
