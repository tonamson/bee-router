...
function createStore({ storageKey, legacyKey, changeEvent, itemField, normalize = (v) => v, defaultName = (v) => v }) {
  const read = () => {
...
const endpoints = createStore({
  storageKey: "bee-router.cliToolEndpointPresets",
  legacyKey: "9router.cliToolEndpointPresets",
  changeEvent: "bee-router:endpoint-presets-changed",
  itemField: "baseUrl",
...
const apiKeys = createStore({
  storageKey: "bee-router.cliToolApiKeyPresets",
  legacyKey: "9router.cliToolApiKeyPresets",
  changeEvent: "bee-router:api-key-presets-changed",
  itemField: "key",
});
