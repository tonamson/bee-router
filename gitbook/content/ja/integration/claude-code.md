...
BeeRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをBeeRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはBeeRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
