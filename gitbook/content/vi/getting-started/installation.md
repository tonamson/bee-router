...
Hướng dẫn cài đặt chi tiết cho BeeRouter với mẹo troubleshooting.
...
Cài BeeRouter toàn cục để dùng ở bất kỳ đâu:
...
3. Data directory được tạo tại `~/.bee-router`
...
**Vấn đề:** BeeRouter dùng quá nhiều RAM
