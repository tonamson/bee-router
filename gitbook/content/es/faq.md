...
Preguntas comunes sobre BeeRouter.

---

## ¿Qué es BeeRouter?

**BeeRouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**BeeRouter usa una estrategia de precios de 3 niveles:**
...
**Sí, BeeRouter en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de BeeRouter.**
...
**BeeRouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Puedo auto-hospedar BeeRouter?

**¡Sí! BeeRouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.bee-router`)
...
**Sí, BeeRouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.bee-router` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de BeeRouter
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/tonamson/bee-router/blob/main/CHANGELOG.md)
- Respalda `~/.bee-router` antes de actualizaciones mayores
...
Consulta [CONTRIBUTING.md](https://github.com/tonamson/bee-router/blob/main/CONTRIBUTING.md) para detalles.
