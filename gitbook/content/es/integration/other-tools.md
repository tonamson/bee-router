...
BeeRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

BeeRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a BeeRouter usando estas configuraciones:

**BeeRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de BeeRouter (cc/*, cx/*, glm/*, etc.)
```

**BeeRouter en la nube:**
```
...
**Problema:** No se puede conectar a BeeRouter
```bash
# Verifica si BeeRouter está corriendo
...
**Solución:**
- Verifica que BeeRouter esté corriendo
...
- Verifica la conexión de red a BeeRouter
