...
Tích hợp BeeRouter với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.

## Yêu cầu

- Roo AI Assistant đã cài đặt
- BeeRouter API key từ [dashboard](https://9router.com/dashboard)
- BeeRouter đang chạy (cục bộ hoặc cloud)
...
Chọn từ các model BeeRouter có sẵn:
...
### Connection Failed
- Xác minh BeeRouter đang chạy: `curl http://localhost:20128/health`
