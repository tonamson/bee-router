...
function resolveStandaloneBuild(appDir, buildDistDir) {
  ...
  // NEXT_TRACING_ROOT_MODE=workspace, e.g. standalone/bee-router/server.js.
...
function buildCliPackage() {
  console.log("📦 Building BeeRouter CLI package with Next.js...\n");
  ...
  // Strip better-sqlite3 (native) — it lives in ~/.bee-router/runtime to avoid
  ...
  if (fs.existsSync(betterDir)) {
    ...
    console.log("✅ Stripped better-sqlite3 (lives in ~/.bee-router/runtime)");
  }
  console.log("");
