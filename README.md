<div align="center">
  <img src="./assets/logo.png" alt="bee-router Logo" width="160"/>
  <br/>
  <img src="./images/bee-router.png?1" alt="bee-router Dashboard" width="800"/>
...
[🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🌐 GitHub](https://github.com/tonamson/bee-router)
...
This repository package is private (`bee-router-app`), so source/Docker execution is the expected local development path.
...
<table>
  <tr>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
        <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với BeeRouter" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw với BeeRouter<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://youtu.be/VQAw612S27Y">
        <img src="https://img.youtube.com/vi/VQAw612S27Y/maxresdefault.jpg" alt="BeeRouter + Claude Code FREE Unlimited Setup" width="300"/>
      </a><br/>
      <b>🇵🇰 اردو / हिन्दी</b><br/>
      <sub>BeeRouter + Claude Code FREE Unlimited Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="BeeRouter Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>BeeRouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://youtu.be/3dF5GIYMrcQ?si=bAyfyiHbARJQAHj_">
        <img src="https://img.youtube.com/vi/3dF5GIYMrcQ/hqdefault.jpg" alt="BeeRouter Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>BeeRouter + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
  ...
  <tr>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with BeeRouter 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + BeeRouter<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup BeeRouter 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy BeeRouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy BeeRouter di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
  <tr>
    <td align="center" width="320">
    ...
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=hPusYX-5Pmw">
        <img src="https://img.youtube.com/vi/hPusYX-5Pmw/maxresdefault.jpg" alt="Hướng Dẫn Setup OpenClaw + BeeRouter: Tạo Bot Zalo AI Tự Động Từ A-Z" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Hướng Dẫn Setup OpenClaw + BeeRouter: Tạo Bot Zalo AI Tự Động Từ A-Z<br/>by <a href="https://github.com/tuanminhhole">tuanminhhole</a></sub>
    </td>
...
> 🎬 **Made a video about BeeRouter?** Submit a [Pull Request](https://github.com/tonamson/bee-router/pulls) adding your video to this section — we'll merge it!

---

## 🛠️ Supported CLI Tools

BeeRouter works seamlessly with all major AI coding tools:
...
Set `X-BeeRouter-Token-Saver: off` to bypass all token savers for one chat request.
...
Headroom is optional and runs separately. BeeRouter calls Headroom's local `/v1/compress` endpoint, then keeps normal routing, fallback, auth, and usage tracking:

```
Client → BeeRouter → Headroom /v1/compress → BeeRouter → provider
```
...
If Headroom is down or returns an error, BeeRouter fails open and sends the original request.
...
- Your CLI tool sends OpenAI format → BeeRouter translates → Provider receives native format
...
> BeeRouter itself **never charges** you anything. You only pay providers directly (if using paid services).
>
...
### 📊 Understanding BeeRouter Costs & Billing

**BeeRouter Billing Reality:**

✅ **BeeRouter software = FREE forever** (open source, never charges)  
...
❌ **BeeRouter never sends invoices** or charges your card
...
- **Cheap providers** (GLM, MiniMax): Pay them directly, BeeRouter just routes
- **FREE providers** (iFlow, Kiro, Qwen): Genuinely free forever, no hidden charges
- **BeeRouter**: Never charges anything, ever
...
The dashboard tracks your token usage and displays **estimated costs** as if you were using paid APIs directly. This is **not actual billing** - it's a reference to show how much you're saving by using free models or existing subscriptions through BeeRouter.
...
<details>
<summary><b>💳 Will I be charged by BeeRouter?</b></summary>

**No.** BeeRouter is free, open-source software that runs on your own computer. It never charges you anything.

**You only pay:**

- ✅ **Subscription providers** (Claude Code $20/mo, Codex $20-200/mo) → Pay them directly on their websites
- ✅ **Cheap providers** (GLM, MiniMax) → Pay them directly, BeeRouter just routes your requests
- ❌ **BeeRouter itself** → **Never charges anything, ever**

BeeRouter is a local proxy/router. It doesn't have your credit card, can't send invoices, and has no billing system. It's completely free software.
...
BeeRouter just routes your requests to them - there's no "catch" or future billing from BeeRouter itself. They're truly free services, and BeeRouter makes them easy to use with fallback support.
...
3. **Use subscription providers last:**
   ...
   - BeeRouter helps maximize their value through quota tracking
...
BeeRouter's smart fallback prevents surprise charges:
...
**You're in control:** Set spending limits per provider in dashboard, and BeeRouter respects them.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. BeeRouter tracks quota per model!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from bee-router dashboard]
...
```json
{
  ...
  "anthropic_api_key": "your-bee-router-api-key"
}
```
...
export OPENAI_API_KEY="your-bee-router-api-key"
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "bee-router/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Note:** OpenClaw only works with local BeeRouter. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
export DATA_DIR="/var/lib/bee-router"
export PORT="20128"
...
# Or use PM2
npm install -g pm2
pm2 start npm --name bee-router -- start
pm2 save
pm2 startup
```
...
- Docker Hub: [`tonamson/bee-router`](https://hub.docker.com/r/tonamson/bee-router)
- GHCR: [`ghcr.io/tonamson/bee-router`](https://github.com/tonamson/bee-router/pkgs/container/bee-router)
...
docker run -d --name bee-router -p 20128:20128 \
  -v "$HOME/.bee-router:/app/data" -e DATA_DIR=/app/data bee-router
```
...
```bash
docker logs -f bee-router
docker restart bee-router
docker stop bee-router && docker rm bee-router
docker pull tonamson/bee-router:latest   # update to latest
```

**Data persistence:** `$HOME/.bee-router/db/data.sqlite` on host ↔ `/app/data/db/data.sqlite` in container.

### Environment Variables

| Variable                                             | Default                                  | Description                                                                         |
| ---------------------------------------------------- | ---------------------------------------- | ----------------------------------------------------------------------------------- |
| `JWT_SECRET`                                         | Auto-generated (`~/.bee-router/jwt-secret`) | JWT signing secret for dashboard auth cookie (override to share across instances)   |
| `INITIAL_PASSWORD`                                   | `123456`                                 | First login password when no saved hash exists                                      |
| `DATA_DIR`                                           | `~/.bee-router`                             | Main app data location (SQLite at `$DATA_DIR/db/data.sqlite`)                       |
...
- Both `${DATA_DIR}` and `~/.bee-router` resolve to the same location in a Docker container — the symlink `/root/.bee-router -> /app/data` is created at build time.
...
Thanks to all contributors who helped make BeeRouter better!

[![Contributors](https://contrib.rocks/image?repo=tonamson/bee-router&max=150&columns=15&anon=1&v=20260309)](https://github.com/tonamson/bee-router/graphs/contributors)

---

## 📊 Star Chart

[![Star Chart](https://starchart.cc/tonamson/bee-router.svg?variant=adaptive)](https://starchart.cc/tonamson/bee-router)

## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — A full-featured TypeScript fork of BeeRouter. Adds 36+ providers, 4-tier auto-fallback, multi-modal APIs (images, embeddings, audio, TTS), circuit breaker, semantic cache, LLM evaluations, and a polished dashboard. 368+ unit tests. Available via npm and Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Rust token-saver. BeeRouter ports its compression pipeline to JS → **−20-40% input tokens** on every request.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral _"why use many token when few token do trick"_. BeeRouter adapts its prompt → **−65% output tokens**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) by **[@DietrichGebert](https://github.com/DietrichGebert)** — _"lazy senior dev"_ skill. BeeRouter injects its YAGNI-first ladder → **fewer tokens, less code, shorter diffs**.

Huge thanks to these authors — without their work, BeeRouter's token-saving features wouldn't exist. ⭐ them on GitHub!
