...
const PROVIDER_NAME = "bee-router";
...
// Build TOML config for BeeRouter (openai provider mode)
const buildBeeRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect BeeRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildBeeRouterConfig(baseUrl, apiKey || "sk_bee-router", model);
