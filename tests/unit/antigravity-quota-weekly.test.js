...
describe("Antigravity weekly quota from retrieveUserQuotaSummary", () => {
  ...
  it("exposes Gemini and Claude/GPT weekly pools so dashboard/quota can render them", async () => {
    ...
    // Pools only: :fetchAvailableModels reports remainingFraction:1 for every
    // model regardless of real usage (verified live 2026-09-08), and those flat
    // entries would both fill the dashboard with fake 100% bars and shadow the
    // pool in readModelQuota's exact-key branch.
