...
Deploy BeeRouter on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.bee-router` | Database and data storage path |
...
Create `/etc/nginx/sites-available/bee-router`:
