...
const APP_NAME = "bee-router";
const APP_LABEL = "com.bee-router.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when bee-router is currently
 ...
 * SIGTERM to the running process. When the running bee-router cli.js was itself
...
<dict>
    ...
    <string>/tmp/bee-router.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/bee-router.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `bee-router.cmd` lookup that depended on the npm prefix path.
