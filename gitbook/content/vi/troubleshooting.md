...
Các vấn đề và giải pháp phổ biến khi dùng BeeRouter.
...
1. **Auto-refresh (mặc định):**
   BeeRouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Nguyên nhân:**
- BeeRouter không chạy
- Port 20128 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động BeeRouter:**
   ```bash
   bee-router
   ```
...
1. **Kiểm tra BeeRouter có chạy không:**
   ```bash
   # Check process
