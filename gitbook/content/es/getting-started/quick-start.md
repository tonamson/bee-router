...
Pon en marcha BeeRouter en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
Apunta tu herramienta de codificación a BeeRouter:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de bee-router]
