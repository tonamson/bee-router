...
Integra BeeRouter con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de BeeRouter.
...
BeeRouter proporciona los siguientes modelos de Codex:
...
```json
{
  ...
  "apiKey": "your-bee-router-api-key",
...
1. Verifica que tu API key sea correcta en el dashboard de BeeRouter
...
1. Verifica que el nombre del modelo coincida con tu configuración de BeeRouter
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de BeeRouter
...
Asegúrate de haber configurado tu API key en el dashboard en la nube de BeeRouter.
