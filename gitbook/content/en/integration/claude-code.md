...
Integrate BeeRouter with Claude Code CLI to route your Anthropic API requests through BeeRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to BeeRouter models:
