...
import { handleAntigravityQuotaError, clearAntigravityStrikes, clearAntigravityQuotaStrikes } from "../services/antigravityQuota.js";
...
import { recordTokenSaveLayers } from "@/lib/tokenSave/events.js";
...
async function handleSingleModelChat(body, modelStr, clientRawRequest = null, request = null, apiKey = null) {
  ...
  while (true) {
    ...
    const result = await handleChatCore({
      ...
      liteEnabled: chatSettings.liteEnabled !== false,
      ...
      onRequestSuccess: async () => {
        ...
        clearAntigravityQuotaStrikes(credentials.connectionId, model);
      }
    });
