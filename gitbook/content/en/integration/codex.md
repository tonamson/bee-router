...
Integrate BeeRouter with OpenAI Codex CLI to route your OpenAI API requests through BeeRouter's intelligent routing system.
...
BeeRouter provides the following Codex models:
...
1. Verify your API key is correct in BeeRouter dashboard
...
1. Verify the model name matches your BeeRouter configuration
2. Check that the OpenAI provider connection is active in BeeRouter dashboard
...
Make sure you have configured your API key in the BeeRouter cloud dashboard.
