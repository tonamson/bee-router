...
Detailed installation guide for BeeRouter with troubleshooting tips.
...
Install BeeRouter globally to use from anywhere:
...
3. Data directory created at `~/.bee-router`
...
**Issue:** BeeRouter using too much RAM
...
# Delete bee-router-related exports
```
