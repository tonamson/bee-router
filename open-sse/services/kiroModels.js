 ...
 * into bee-router-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are bee-router fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic bee-router variant set for a single upstream Kiro model.
 *
 ...
 * into bee-router variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
